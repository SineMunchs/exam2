    ...
    <div class="flex flex-row w-full justify-center items-center">
       <div class="grid border border-black flex-grow m-20 mt-3 w-full relative">
         <div class="p-1">
          ...
          <div class="flex space-x-20 justify-center ml-80 mb-40">
               ...
               <div class="border border-black p-20 custom-width text-8xl text-[#5C442B] cursor-pointer hover:text-[#EFB34B]"><a href="https://www.eventim-light.com/dk/a/6268ebc70e2f6b59c13b0fac/e/6656fcdfe820523242408b25" target="blank">29</a></div>
           </div>
       </div>
   </div>
